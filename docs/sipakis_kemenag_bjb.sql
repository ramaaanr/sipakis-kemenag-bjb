...
INSERT INTO `jabatan_staff` (`id`, `nama`) VALUES
(1, 'Kyai/Ustadz'),
(2, 'Guru'),
...
INSERT INTO `jenis_lembaga_pendidikan` (`id`, `nama`) VALUES
(1, 'Pondok Pesantren'),
...
INSERT INTO `kecamatan` (`id`, `nama`, `deleted_at`) VALUES
(1, 'Banjarbaru Utara', NULL),
(2, 'Banjarbaru Selatan', NULL),
(3, 'Cempaka', NULL),
(4, 'Liang Anggang', NULL),
(5, 'Landasan Ulin', NULL);
...
(4, 'Stanton.Lubowitz', '$2y$10$Sbe0vDZmvWrpGMl.6JuEI.5Ybri8ulItS3BlKFVAgdVOvgpH65OHG', '', NULL, '2025-06-06 16:26:30');
