  ...
  <div class="container px-6 py-8 mx-auto">
    ...
    <div class="mt-4">
      <div class="flex flex-wrap -mx-6 ">
        ...
        <!-- Dashboard Kartu Cetak untuk Pimpinan -->
        <?php if ($role === 'pimpinan' || $role === 'admin'): ?>
          <!-- Lembaga -->
          <a target='_blank' href="/lembaga-cetak" class="w-full my-4 px-6 sm:w-1/2 xl:w-1/3 cursor-pointer">
            <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
              <div class="w-12 h-12 flex justify-center items-center bg-indigo-600 bg-opacity-75 rounded-full">
                <span class="material-symbols-outlined text-white">apartment</span>
              </div>
              <div class="mx-3">
                <h4 class="text-xl font-semibold text-gray-700">Cetak Lembaga</h4>
                <div class="text-gray-500">Cetak Data Lembaga</div>
              </div>
            </div>
          </a>

          <!-- Jenis Lembaga -->
          <a target='_blank' href="/jenis-lembaga-cetak" class="w-full my-4 px-6 sm:w-1/2 xl:w-1/3 cursor-pointer">
            <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
              <div class="w-12 h-12 flex justify-center items-center bg-amber-600 bg-opacity-75 rounded-full">
                <span class="material-symbols-outlined text-white">category</span>
              </div>
              <div class="mx-3">
                <h4 class="text-xl font-semibold text-gray-700">Cetak Jenis Lembaga</h4>
                <div class="text-gray-500">Cetak Data Jenis Lembaga</div>
              </div>
            </div>
          </a>

          <!-- Operator -->
          <a target='_blank' href="/operator-cetak" class="w-full my-4 px-6 sm:w-1/2 xl:w-1/3 cursor-pointer">
            <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
              <div class="w-12 h-12 flex justify-center items-center bg-lime-600 bg-opacity-75 rounded-full">
                <span class="material-symbols-outlined text-white">person_outline</span>
              </div>
              <div class="mx-3">
                <h4 class="text-xl font-semibold text-gray-700">Cetak Operator</h4>
                <div class="text-gray-500">Cetak Data Operator</div>
              </div>
            </div>
          </a>

          <!-- Kecamatan -->
          <a target='_blank' href="/kecamatan-cetak" class="w-full my-4 px-6 sm:w-1/2 xl:w-1/3 cursor-pointer">
            <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
              <div class="w-12 h-12 flex justify-center items-center bg-teal-600 bg-opacity-75 rounded-full">
                <span class="material-symbols-outlined text-white">location_city</span>
              </div>
              <div class="mx-3">
                <h4 class="text-xl font-semibold text-gray-700">Cetak Kecamatan</h4>
                <div class="text-gray-500">Cetak Data Kecamatan</div>
              </div>
            </div>
          </a>

          <!-- Jabatan Staff -->
          <a target='_blank' href="/jabatan-staff-cetak" class="w-full my-4 px-6 sm:w-1/2 xl:w-1/3 cursor-pointer">
            <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
              <div class="w-12 h-12 flex justify-center items-center bg-cyan-600 bg-opacity-75 rounded-full">
                <span class="material-symbols-outlined text-white">badge</span>
              </div>
              <div class="mx-3">
                <h4 class="text-xl font-semibold text-gray-700">Cetak Jabatan Staff</h4>
                <div class="text-gray-500">Cetak Data Jabatan</div>
              </div>
            </div>
          </a>

          <!-- Staff -->
          <a target='_blank' href="/staff-cetak" class="w-full my-4 px-6 sm:w-1/2 xl:w-1/3 cursor-pointer">
            <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
              <div class="w-12 h-12 flex justify-center items-center bg-rose-600 bg-opacity-75 rounded-full">
                <span class="material-symbols-outlined text-white">diversity_3</span>
              </div>
              <div class="mx-3">
                <h4 class="text-xl font-semibold text-gray-700">Cetak Staff</h4>
                <div class="text-gray-500">Cetak Data Staff</div>
              </div>
            </div>
          </a>

          <!-- Murid -->
          <a target='_blank' href="/murid-cetak" class="w-full my-4 px-6 sm:w-1/2 xl:w-1/3 cursor-pointer">
            <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
              <div class="w-12 h-12 flex justify-center items-center bg-emerald-600 bg-opacity-75 rounded-full">
                <span class="material-symbols-outlined text-white">groups</span>
              </div>
              <div class="mx-3">
                <h4 class="text-xl font-semibold text-gray-700">Cetak Murid</h4>
                <div class="text-gray-500">Cetak Data Murid</div>
              </div>
            </div>
          </a>

          <!-- User -->
          <a target='_blank' href="/user-cetak" class="w-full my-4 px-6 sm:w-1/2 xl:w-1/3 cursor-pointer">
            <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
              <div class="w-12 h-12 flex justify-center items-center bg-fuchsia-600 bg-opacity-75 rounded-full">
                <span class="material-symbols-outlined text-white">manage_accounts</span>
              </div>
              <div class="mx-3">
                <h4 class="text-xl font-semibold text-gray-700">Cetak User</h4>
                <div class="text-gray-500">Cetak Data User</div>
              </div>
            </div>
          </a>
        <?php endif; ?>
