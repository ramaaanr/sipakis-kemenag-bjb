...
<div class="relative flex flex-col justify-between items-center px-6 lg:px-8 py-5 min-h-screen">
  ...
  <!-- Background gradient -->
  <div class="absolute inset-0 bg-gradient-to-b from-[#11998e] to-[#38ef7d] -z-10"></div>

  <!-- Image as second background layer -->
  <div class="absolute inset-0 bg-cover bg-center bg-no-repeat -z-5"
    style="background-image: url('/public/mosque-bg.png'); opacity: 0.1;"></div>
  ...
  <div
    ...
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
      <h2 class="mt-5 text-center text-2xl font-bold leading-9 tracking-tight text-zinc-700">SIPAKIS
      </h2>
    ...
    <div class="sm:mx-auto sm:w-full sm:max-w-sm h-fit">
      <form id="loginForm" class="space-y-3">
        ...
        <div>
          <button type="submit"
            class="flex w-full mt-12 justify-center rounded-md bg-green-400 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-lime-600">Login</button>
        </div>
      </form>
    </div>
  </div>
