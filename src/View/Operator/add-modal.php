...
<div id="addModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden">
  <div class="relative top-20 mx-auto p-5 border w-1/3 shadow-lg rounded-md bg-white">
    ...
    <form id="addForm">
      ...
      <div class="mb-4">
        <label for="user_id" class="block text-sm font-medium text-gray-700">Operator User</label>
...
<script>
  ...
  $('#btn-add').on('click', function() {
    ...
    populateSelect('/user-operator', '#user_id');
  });
  ...
  $('#addForm').on('submit', function(e) {
    ...
    $.ajax({
      url: '/operator-lembaga-pendidikan', // Adjust the URL to your endpoint
      method: 'POST',
      data: $(this).serialize(),
